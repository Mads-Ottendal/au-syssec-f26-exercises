...
2. Find a way to bound the number of iterations of the algorithm such that it does not leak how long the private exponent is.
Hint: think of how to use a public parameter to fix a maximum number of iterations.
3. **BONUS**: Implement the [Montgomery Ladder](https://en.wikipedia.org/wiki/Exponentiation_by_squaring#Montgomery's_ladder_technique) algorithm.
